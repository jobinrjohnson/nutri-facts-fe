            ...
            <div className='col'>
                <table className='w-100 nutri-tab'>
                    ...
                    <tr>
                        ...
                        <td>{facts.fat?.totalFat?.quantity}</td>
                    </tr>
                    <tr>
                        <td>
                            Saturated Fat:
                        ...
                        <td>{facts.fat?.saturatedFat?.quantity}</td>
                    </tr>
                    <tr>
                        <td>
                            Trans Fat:
                        ...
                        <td>{facts.fat?.transFat?.quantity}</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>{facts.cholesterol?.quantity}</td>
                    </tr>
                    {/*Carbohydrate*/}
                    <tr>
                        <th>
                        ...
                        <td>{facts.carbohydrate?.totalCarbohydrate?.quantity}</td>
                    </tr>
                    <tr>
                        <td>
                            Dietary Fiber:
                        ...
                        <td>{facts.carbohydrate?.dietaryFiber?.quantity}</td>
                    </tr>
                    <tr>
                        <td>
                            Total Sugars:
                        ...
                        <td>{facts.carbohydrate?.totalSugars?.quantity}</td>
                    </tr>
                    <tr>
                        <th>
                            Protein:
