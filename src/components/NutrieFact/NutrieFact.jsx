                    ...
                    <div className='row align-items-center'>
                        <div className='col-auto pe-0'>
                            <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M8.52911 9.52911V21.7229L10.0549 20.2988C10.2319 20.1336 10.4649 20.0418 10.707 20.0418H22.2911V9.52911H8.52911ZM7 8.9557C7 8.42788 7.42788 8 7.9557 8H22.8645C23.3924 8 23.8202 8.42788 23.8202 8.9557V20.6152C23.8202 21.143 23.3924 21.5709 22.8645 21.5709H10.933L8.60778 23.7411C7.99688 24.3113 7 23.878 7 23.0424V8.9557ZM14.579 11.3684H16.2632V15.5789H14.579V11.3684ZM16.2632 16.4211H14.579V18.1054H16.2632V16.4211Z" fill="#6DB5DD" />
                            </svg>
