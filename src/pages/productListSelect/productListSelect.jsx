            ...
            <div className='selectbar p-5'>
                <div>
                    ...
                    <div>
                        ...
                        <table className='table table-borderless ms-5 w-100'>
                            <tbody>
                            ...
                            {Object.keys(this.props.results).map(x => {
                                return (<tr>
                                    ...
                                    <td width="40"><img width="38" src={"https://lgpoc1.s3.amazonaws.com/"+x}/></td>
                                    <td className='tabletext'>{x}</td>
                                </tr>)
                            })}
